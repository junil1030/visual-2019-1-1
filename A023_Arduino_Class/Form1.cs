...
namespace Arduino_Class1
{
  public partial class Form1 : Form
  {
    ...
    List<SensorData> myData = new List<SensorData>();
        string connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\konynag\Desktop\Arduino_Class1\Arduino_Class1\SensorData.mdf;Integrated Security = True";
    ...
    private void ShowValue(string s)
    {
      ...
      btnPortValue.Text = /*sPort.PortName +*/ "\n" + s;
        ...
        private void DBInsert(SensorData data)
        {
            ...
            //insert into SensorTable(Date,Time,Value)Values( , ,)
    ...
    private void btnDisconnect_Click(object sender, EventArgs e)
    {
        ...
        {
            int v = r.Next(1024); //0에서 1024까지의 랜덤 값
            ShowValue(v.ToString());
        }
    }
}
